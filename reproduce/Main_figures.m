...
alpha=0.5;
[prcc, prcc_sign,sign_indices,sign_param,sign_prccvalues] = PRCC_modified(newdataVmax_TKT', newdata.v', Enames, alpha);
...
[prcc2, prcc_sign2,sign_indices2,sign_param2,sign_prccvalues2] = PRCC_modified(newdataVmax_TKT', newdata.gCgN', Enames, alpha);
...
[prcc, prcc_sign,sign_indices,sign_param,sign_prccvalues] = PRCC_modified(newdataVmax_TKT', newdata_vALTNout', Enames, alpha);
...
[ T1, X1, FLUXss1 ] = JRRrunSimulation(Vmax1,tspan,x0,options);
