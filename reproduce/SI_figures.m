...
text(transportratio, gCgN_median, '   Control (1.361, 4.381)', 'FontSize', 14);  % Optional label slightly above the point
hold off;
...
text(transportratio, Nfix_median, '   Control (1.361, 1.107)', 'FontSize', 14);  % Optional label slightly above the point
hold off;
