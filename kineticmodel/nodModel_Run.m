...
%
% This MATLAB script allows to load kinetic model and perform the simulations.
%
...
% run ODE
[ T, X, FLUXss ] = nodrunSimulation(Vmaxnew,tspan,x0,options);
...
slope_last100=nodModel_ODE(T(tpoints_last100),X(tpoints_last100,:),Vmaxnew);
slopeend=nodModel_ODE(T(end),X(end,:),Vmaxnew);
